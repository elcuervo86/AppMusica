...
class BlogRock(models.Model):
    ...
    def __str__(self):
        return f"Titulo: {self.titulo} - Fecha: {self.fecha} - Subtitulo: {self.subtitulo} - Cuerpo: {self.cuerpo}"
...
class Comentario(models.Model):
    ...
    def __str__(self):
        return f"Nombre: {self.nombre} - Fecha: {self.fecha} - Comentario: {self.contenido}"
